...
import { type Schedule, apiFetch } from '@/lib/api';
              ...
              <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                <div className="flex-1">
                  <div className="mb-3 flex flex-wrap items-center gap-3">
                    ...
                    <span className="rounded-full border border-ops-border bg-ops-surface-raised px-2.5 py-0.5 text-[10px] text-[var(--color-text-secondary)]">
                      {sched.agent_name}
                    </span>
                    <span
                  ...
                  <div className="flex flex-col gap-3 text-sm text-[var(--color-text-secondary)]">
                    ...
                    <span className="leading-6 text-[var(--color-text-secondary)]">
                      {sched.prompt}
                    </span>
                  </div>
                </div>
