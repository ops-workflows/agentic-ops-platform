...
function LogoIcon() {
  return (
    <svg width="36px" viewBox="0 0 40 36" role="presentation" xmlns="http://www.w3.org/2000/svg">
      <line x1="20" y1="5" x2="35" y2="31" stroke="#C4622D" stroke-width="1.4" stroke-linecap="round"/>
      <line x1="20" y1="5" x2="5" y2="31" stroke="#C4622D" stroke-width="1.4" stroke-linecap="round"/>
      <line x1="5" y1="31" x2="35" y2="31" stroke="#C4622D" stroke-width="1.4" stroke-linecap="round"/>
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-4 py-3 sm:px-6 md:px-8 md:py-4">
        <a href="/" className="group flex items-center gap-2 no-underline">
          ...
          <div className="flex flex-col leading-none gap-[3px]">
            <span className="text-[9px] uppercase tracking-[0.18em] px-[3px] text-[var(--color-text-tertiary)] transition-colors group-hover:text-[var(--color-accent)]">Control Plane</span>
            <span className="font-sans text-[22px] leading-none">
              <span className="text-[#9B9184] font-light">Agentic </span>
              <span className="text-[var(--color-text-primary)] font-medium">Ops</span>
            </span>
          </div>
        </a>
